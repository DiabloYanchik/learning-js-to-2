    ...
    <div className="welcome-wrap">
      ...
      <section className="welcome-section">
        ...
        <p className="welcome-section-sub">
            ...
            Однако один из участников миссии по позывному "Астронавт" заблудился в измерении именуемое как "JavaScript".
           <b>Вы - участник данной миссии. Ваша задача спасти Астронавта. </b>
             Для его спасения и выхода из затруднительного положения необходимо прокачать свои навыки,
            выполнить все задачи, собрать все звёзды и получить сертификат (билет домой для Астронавта).
            (как капитан говорит, код — это палочка-выручалочка, но иногда он становится лабиринтом)
